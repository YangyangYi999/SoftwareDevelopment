 ...
 * @author shinychenw
 */
public class ManageSecureAlertsJPanel extends javax.swing.JPanel {
    ...
    Statistic statistic;
    State state;
    ManageSecureAlertsJPanel(JPanel userProcessContainer, DataManageOrganization dataManageOrganization, Statistic statistic, State state) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for (Alert a : statistic.getSecureAlertDirectory().getAlertList()){
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Manage Secure Alerts");
