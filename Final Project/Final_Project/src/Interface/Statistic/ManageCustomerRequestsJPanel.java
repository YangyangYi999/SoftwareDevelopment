...
public class ManageCustomerRequestsJPanel extends javax.swing.JPanel {
    ...
    Statistic statistic;
    State state;
    ManageCustomerRequestsJPanel(JPanel userProcessContainer, DataManageOrganization dataManageOrganization, Statistic statistic, State state) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for (WorkRequest w : statistic.getCustomerRequestDirectory().getWorkRequestList()){
            Object[] row = new Object[4];
            row[0] = w.getCustomer();
            row[1] = w.getRequestDate();
            row[2] = w.getResolveDate();          
            row[3] = w.getCustomer().getLocation();
            model.addRow(row);
        }
    }
    ...
    private void initComponents() {
        ...
        jTableAlert.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer Name", "SendDate", "HandledDate", "Address"
            }
        ));
